...
const profile = {
  ...
  <div className="absolute -z-10 top-1/2 -translate-y-1/2 left-1/4 w-24 sm:w-32 h-24 sm:h-32 bg-blue-500/20 rounded-full blur-2xl animate-pulse"></div>
              ...
              <div className="mb-4">
                <a 
                href="https://drive.google.com/file/d/1v0MvHDWypb4539QhlfRH0GAfYES5pMK8/view?usp=sharing"
                target="_blank"
...
<div className="flex items-center space-x-6 mt-6">
  {/* GitHub */}
  <a
    href="https://github.com/ihimanshu17"
    target="_blank"
    rel="noopener noreferrer"
    title="GitHub"
  ...
  {/* LinkedIn */}
  <a
    href="https://www.linkedin.com/in/ihimanshu17/"
    target="_blank"
    rel="noopener noreferrer"
    title="LinkedIn"
  ...
  {/* LeetCode */}
  <a
    href="https://leetcode.com/u/ihimanshu17/"
    target="_blank"
    rel="noopener noreferrer"
    title="LeetCode"
